...
interface AdditionalDetailsComboboxProps {
 ...
 */
export function AdditionalDetailsCombobox({
  options,
  selected,
  onChange,
        ...
        <PopoverTrigger asChild>
          ...
          >
            {selected.length > 0
              ...
              : "Add details (ruffles, pleats, embroidery...)"}
          </Button>
        </PopoverTrigger>
        <PopoverContent
          ...
          <Command shouldFilter={false}>
            ...
            <CommandList>
              {filtered.length === 0 && !search && (
                <CommandEmpty>No additional details found.</CommandEmpty>
              )}
              {filtered.length > 0 && (
                <CommandGroup>
                  {filtered.map((opt) => (
